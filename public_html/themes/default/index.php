...
<?php endif; ?>
<link type="text/css" rel="stylesheet" media="screen" href="/style/application.css">
    ...
    <div class="row-fluid search-button-bar-container">
      <div class="span12">
		...
		<div id="htab_newtask">
			...
			<a href="#" id="newtask_adv" class="search-button-trigger button newtask mtt-htabs" title="<?php _e('advanced_add');?>"><i class="icon-th-large"></i></a>
			<!-- <a href="#" class="search-button-trigger"><i class="icon-search"></i></a>   -->
...
<div class="black-box tex padded">
...
<div class="box">
<div class="tab-header mtt-inadd"><?php _e('add_task');?>
...
<div class="tab-header mtt-inedit"><?php _e('edit_task');?><div id="taskedit-date" class="mtt-inedit">
...
<input type="hidden" name="id" value="" />
	...
	<div class="span6">
		...
		<select name="prio" class="option">
		<option value="2"  class="option">+2</option>
		<option value="1"  class="option">+1</option>
		<option value="0" selected="selected"  class="option">&plusmn;0</option>
		<option value="-1"  class="option">&minus;1</option>
		</select>
		</div>
