...
<p><a href="http://content.the-design.org/">БЛОГ</a></h2></p>


<ul class="nav">
    <li>
    	<a class="active" title="" href="#settings"><span><a id="settings"><?php _e('a_settings');?></a></span></a>
    </li>
    <li>
    	<a class="active" id="tagcloudbtn"><span>Темы</a></span></a>
	    ...
	    <div class="whead">
	      ...
	      <div class="titleOpt">
				...
				<div id="list_all" class="mtt-tab mtt-tabs-alltasks mtt-tabs-hidden list_all">
		      		<a class="sideB bLightBlue" href="#alltasks"><span><?php _e('alltasks'); ?></span>
